                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('video-save-create') }}" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <input class="form-control @error('video_url') is-invalid @enderror" name="video_url" readonly="readonly" id="video_url" type="text" value="{{ old('video_url') }}">
